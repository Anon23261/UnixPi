...
def main():
    ...
    if requirements_file.exists():
        ...
        for package, required_version in requirements:
            ...
            elif required_version and pkg_resources.parse_version(installed_packages[package]) < pkg_resources.parse_version(required_version):
                outdated_packages.append((package, required_version, installed_packages[package]))
    ...
    print("======================")
    if missing_deps or (requirements_file.exists() and (missing_packages or outdated_packages)):
